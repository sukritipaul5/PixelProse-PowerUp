...
#PBS -q prod
#PBS -A DemocAI
#PBS -o /lus/eagle/projects/DemocAI/sukriti/sd3m-cw/logs/sd3m_fft_out_sukriti_cw_verysmallprod.log
#PBS -e /lus/eagle/projects/DemocAI/sukriti/sd3m-cw/logs/sd3m_fft_err_sukriti_cw_verysmallprod.log


# Clear log files before the job starts
: > /lus/eagle/projects/DemocAI/sukriti/sd3m-cw/logs/sd3m_fft_out_sukriti_cw_verysmallprod.log
: > /lus/eagle/projects/DemocAI/sukriti/sd3m-cw/logs/sd3m_fft_err_sukriti_cw_verysmallprod.log
...
export OUTPUT_DIR="/lus/eagle/projects/DemocAI/sukriti/sd3m-cw/outputs/sd3m_verysmallprod"
...
SCRIPT="/lus/eagle/projects/DemocAI/sukriti/sd3m-cw/train_sd3m_cw.py"
...
#pixelprose for val
#adam_weight_decay: smaller 1e-4 or 0 from 1e-2
#epsilon  1e-15  from 1e-8
#lr 1e-4 from 1e-5